...
public class OrderDetail extends BaseEntity {
    ...
    public String getFlashSaleItemId() {
        return flashSaleItemId;
    }

    public void setFlashSaleItemId(String flashSaleItemId) {
        this.flashSaleItemId = flashSaleItemId;
    }
    ...
    public String toCsvLine() {
        return String.join(",", getId(), orderId, flashSaleItemId, String.valueOf(quantity),
                String.valueOf(priceAtPurchase));
    }
