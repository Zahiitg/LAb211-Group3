...
public class Product extends BaseEntity {
    ...
    public String toCsvLine() {
        return String.join(",", getId(), sellerId, CsvUtil.escapeCsv(name), CsvUtil.escapeCsv(category),
    ...
    public void fromCsvLine(String line) {
        ...
        setId(parts[0].trim());
        this.sellerId = parts[1].trim();
        this.name = CsvUtil.unescapeCsv(parts[2]).trim();
