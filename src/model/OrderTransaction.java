...
public class OrderTransaction extends BaseEntity {
    ...
    public OrderTransaction(String id, String orderId, LockMechanism lockMechanism, int retryCount,
    ...
    public String toCsvLine() {
        return String.join(",", getId(), orderId, lockMechanism.name(), String.valueOf(retryCount),
                String.valueOf(processingTimeMs), String.valueOf(success).toUpperCase());
    }
